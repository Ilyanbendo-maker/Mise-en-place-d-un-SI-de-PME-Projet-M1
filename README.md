...
| Brique | Membres |
|---|---|
| Premier et second pare-feu | Paul |
| DNS | Gabriel |
| PKI | Sacha, Adèle |
| Active Directory | Sacha |
| Messagerie | Adèle |
| Web | Adèle |
| WSUS | Gabriel |
| VPN | Sacha |
| Bastion | Gabriel, Sacha |
| Proxy | Ilyan |
| Reverse proxy et WAF | Nicolas |
| SIEM, EPP, EDR | Paul, Adèle |
| Backup | Paul |
| Ansible | Ilyan |
| Hardening Windows | Gabriel, Sacha |
| Hardening Linux | Maxime, Sacha, Tiphaine |
| Serveur de fichiers | Nicolas |
| Keycloak SSO | Ilyan |
| ERP | Tiphaine |
| Machine d'attaque | Adèle |
